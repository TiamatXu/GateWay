...
- **总估算**：32–45 周（约 8–11 个月），单人 + Claude Code
...
3. `cargo check` 通过全部 trait 定义，无 `todo!()` 残留于类型签名
...
| 前端工作量失控 | M8 | 估算已标注为乐观值；必要时先交付管理 API，UI 分批 |
...
| M3 | 句柄与异步托管 | 3–4 周 | 12–17 |
| M4 | Duplex 实时 | 3–4 周 | 15–21 |
| M5 | 计价完整 | 2–3 周 | 17–24 |
| M6 | 转换适配器 | 4–6 周 | 21–30 |
| M7 | 组织与身份 | 5–7 周 | 26–37 |
| M8 | 管理面 | 6–8 周 | 32–45 |
